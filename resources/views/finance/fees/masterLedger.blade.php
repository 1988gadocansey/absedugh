...
@endif
 ...
 <div style="">
     <div class="uk-margin-bottom" style="margin-left:821px" >
                ...
                <form action="{!!    url('view_payments_master')  !!}"  method="get" accept-charset="utf-8" novalidate id="group">
                   {!!  csrf_field()  !!}
                    <div class="uk-grid" data-uk-grid-margin="">
                        ...
                        <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                                  {!!  Form::select('status', array('Admitted'=>'Admitted','In school'=>'In school','Alumni' => 'Completed','Deferred' => 'Deferred','Dead' => 'Dead','Rusticated' => 'Rusticated','Withdrawn' => 'Withdrawn','Unknown' => 'Unknown'), null, ['placeholder' => 'select status of student','id'=>'parent','value'=>'In school','class'=>'md-input parent'],old("status","")); !!}
                         </div>
                        </div>
