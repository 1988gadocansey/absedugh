                    ...
                    <form  action="{{url('/download_results')}}" enctype="multipart/form-data" id="form" accept-charset="utf-8" method="POST" name="applicationForm"  v-form>
                        ...
                        <div class="uk-grid" data-uk-grid-margin>
                                ...
                                <div class="uk-width-medium-1-3">
                                    <div class="uk-form-row">    
                                    <table align="left">
                                        <tr><td><label>Combined</label><br/>
                                        <input type="radio" id="combine" name="combine" value="yes">
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" id="combine" name="combine" value="no" checked>
                                        </td>
                                        <td>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        </td>
                                        <td>
                                        <input type="submit" value="Download" id='saves'   class="md-btn   md-btn-success uk-margin-small-top">
                                        </td></tr>
                                        <tr><td><label>&nbsp;&nbsp;Y&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;N</label>
                                        </td>
                                        </tr>
                                    </table>
                                    </div>
