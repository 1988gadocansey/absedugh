...
@section('content')
    ...
    <div style="" class="">
        ...
        <div class="uk-margin-bottom" style="">
            @if(@\Auth::user()->department=="Tptop2" || @\Auth::user()->department=="Tptop")
            ...
            <div class="md-card-content">
                ...
                <form action=" " method="get" accept-charset="utf-8" novalidate id="group">
                    ...
                    <div class="uk-grid" data-uk-grid-margin="">
                        ...
                        @if(@\Auth::user()->role=='Dean' || @\Auth::user()->department=="Tpmid" || @\Auth::user()->department=="Tptop" || @\Auth::user()->department=="Tptop3"|| @\Auth::user()->department=="Tptop4"|| @\Auth::user()->department=="Tptop5"|| @\Auth::user()->department=="Tptop2" || @\Auth::user()->department=="Finance" || @\Auth::user()->department=="Rector" || @\Auth::user()->role=="Rector" || @\Auth::user()->department=="Registrar" || @\Auth::user()->department=="Admissions" ||  @\Auth::user()->department=="Planning"  || @\Auth::user()->role=="Accountant" || @\Auth::user()->department == 'Examination' || @\Auth::user()->role == 'Admin' || @\Auth::user()->department == 'top')
                            <div class="uk-width-medium-1-5">
                                <div class="uk-margin-small-top">
                                    {!! Form::select('school',
                                    (['' => 'by schools'] +$school  ),
    ...
    <div class="uk-width-xLarge-1-1">
        <div class="md-card">
            <div class="md-card-content">
                ...
                <div class="uk-overflow-container" id='print'>
                    ...
                    <table class="uk-table uk-table-hover uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair"
                        ...
                        <tr>
                            ...
                            @if(@\Auth::user()->role=='Dean' || @\Auth::user()->department=="Tpmid" || @\Auth::user()->role=="FSupport" || @\Auth::user()->department=="Tptop" || @\Auth::user()->department=="Tptop2"|| @\Auth::user()->department=="Tptop3"|| @\Auth::user()->department=="Tptop4"|| @\Auth::user()->department=="Tptop5"|| @\Auth::user()->department=="Rector" || @\Auth::user()->role=="Rector" || @\Auth::user()->role=="Accountant"  || @\Auth::user()->department == 'top' ||  @\Auth::user()->department=="LA")
                                <th>PHONE</th>
                            @endif
                            <th>NATIONALITY</th>
                            <th>YEAR BILLS</th>
                            @if(@\Auth::user()->role=='Dean' || @\Auth::user()->department=="Tpmid" || @\Auth::user()->role=="FSupport" || @\Auth::user()->department=="Tptop" || @\Auth::user()->department=="Tptop2"|| @\Auth::user()->department=="Tptop3"|| @\Auth::user()->department=="Tptop4"|| @\Auth::user()->department=="Tptop5"|| @\Auth::user()->department=="Finance" || @\Auth::user()->department=="Planning" || @\Auth::user()->department=="Rector" || @\Auth::user()->role=="Rector" || @\Auth::user()->role=="Accountant"  || @\Auth::user()->department == 'top' ||  @\Auth::user()->department=="LA")
                                <th>PAID</th>
                                <th>OWINGS</th>
                                <th>PASSWORD</th>
                            @endif
                ...
                @if(@\Auth::user()->role=='Dean' || @\Auth::user()->department=="Tpmid" || @\Auth::user()->department=="Tptop"  || @\Auth::user()->department=="Tptop2"|| @\Auth::user()->department=="Tptop3"|| @\Auth::user()->department=="Tptop4"|| @\Auth::user()->department=="Tptop5"|| @\Auth::user()->department=="Rector" || @\Auth::user()->role=="Rector" || @\Auth::user()->role=="Accountant" || @\Auth::user()->role=="FSupport"  || @\Auth::user()->department == 'top' ||  @\Auth::user()->department=="LA")
                ...
                <td>GHC {{ @$row->BILLS }}</td>
                @if(@\Auth::user()->role=='Dean' || @\Auth::user()->department=="Tpmid" || @\Auth::user()->department=="Tptop"  || @\Auth::user()->department=="Tptop2"|| @\Auth::user()->department=="Tptop3" || @\Auth::user()->role=="FSupport"|| @\Auth::user()->department=="Tptop4"|| @\Auth::user()->department=="Tptop5"|| @\Auth::user()->department=="Finance" || @\Auth::user()->department=="Rector" || @\Auth::user()->role=="Rector" || @\Auth::user()->role=="Accountant"  || @\Auth::user()->department=="Planning" || @\Auth::user()->department == 'top' ||  @\Auth::user()->department=="LA")
                    <td>GHC {{ @$row->PAID }}</td>
