...
<html lang="en">
    <head>
        <title>SRMS | Accra Business School</title>
    ...
    <body>
        ...
        @yield('content')
        <small class="footer uk-text-small"><center><?php date("Y");?> All Rights Reserved | Accra Business College - Powered by Tpconnect </center></small>
