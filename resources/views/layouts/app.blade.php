        ...
        <nav class="uk-navbar">
            <div class="main_logo_top">
                <a href="/dashboard"><img src='{{url("public/assets/img/logo.png")}}' alt="" height="15"
                                          width="71"/></a>
                <span class="" style="color:white">URPS-ABS</span>
            ...
            <ul id="menu_top" class="uk-clearfix">
                    ...
                    <li data-uk-dropdown class="uk-hidden-small">
                        ...
                        <div class="uk-dropdown uk-dropdown-scrollable">
                            <ul class="uk-nav uk-nav-dropdown">
                                ...
                                <li><a href='http://applications.ABSportal.com' target="_">Add Applicants</a></li>
                ...
                @else
                    ...
                    @if( @Auth::user()->department=='Tptop' ||  @Auth::user()->department=='Tptop4' || @Auth::user()->department=='Tptop2' || @Auth::user()->department=='Tptop3' )
                        ...
                        <li data-uk-dropdown class="uk-hidden-small">
                            <a href="#"> <i
                                        class="sidebar-menu-icon material-icons">attach_file</i><span>Students Management</span></a>
                            <div class="uk-dropdown uk-dropdown-scrollable">
                                <ul class="uk-nav uk-nav-dropdown">
                                    ...
                                    <li><a href='{!! url("/download_regList") !!}'>Registered Students</a></li>
