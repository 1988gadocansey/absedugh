    ...
    margin-bottom: 20px;" border="0" class="gad uk-table uk-table-condensed uk-table-striped ">
                    ...
                    <table border="0" style="margin-left: 507px; padding: 2px">
                        ...
                        <tr>
                            ...
                            <td>
                                <u><?php echo $sys->getSemesterCredit($rs['sem'], $rs['level'], $rs['year'], $rs['indexno']); ?></u>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>Grade Points:</td>
                            <td>
                                <u><?php echo $sys->getSemesterGP($rs['sem'], $rs['level'], $rs['year'], $rs['indexno']); ?></u>
                            </td>
                        ...
                        <tr style="color:#418eff">
                            ...
                            <td>CWA:</td>
                            <td>
                                <u><?php echo $sys->getCWA($rs['sem'], $rs['level'], $rs['year'], $rs['indexno']); ?></u>
                            </td>
...
//}
...

    {
        ...
        return Excel::create($course . '_' . $programme, function ($excel) use ($data, $program, $level, $programme, $kojoSense, $course, $dpt3, $fac3, $courced, $lectname,$sem,$year) {

            $excel->sheet($program, function ($sheet) use ($data, $kojoSense, $program, $level, $programme, $course, $dpt3, $fac3, $courced, $lectname,$year,$sem) {
                $sheet->setWidth(array(
                    'A' => 15,
                    'B' => 35,
                    'C' => 8,
                ...
                $sheet->fromArray($data);
                $sheet->setBorder('A1:H' . $kojoSense . '', 'thin');
                //$sheet->setCellsValue('C2:F'.$kojoSense.'','0');
                //$sheet->cells('C2:C5', function($cells) {
...
//});
    ...
    public function attendanceSheet(Request $request,SystemController $sys){
        if(@\Auth::user()->role=='HOD' || @\Auth::user()->department=='top' || @\Auth::user()->department=='Tptop'|| @\Auth::user()->role=='Dean' || @\Auth::user()->role=='Support' || @\Auth::user()->department=='Rector' || @\Auth::user()->department=='Tpmid' || @\Auth::user()->department=='Finance' || @\Auth::user()->department=='Tptop'){
            if ($request->isMethod("get")) {
...
//                            }
                ...
                throw new HttpException(Response::HTTP_UNAUTHORIZED, 'Result uploads not open.');
            }
        }
        else{
