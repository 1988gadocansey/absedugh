...
class APIController extends Controller
{
    ...
    public function getApplicant(Request $request, SystemController $sys){
        ...
        foreach ( $request->input() as $student) {
            # code...
                    ...
                    if (empty($data)) {
                        ...
                        foreach ($a as $i) {
                            ...
                            elseif ($bank=="0189104488868901"){
                                $feeLedger->RECIEPIENT = "API_ECOBANK";
                            }
                            elseif ($bank=="6010407060"){
                                $feeLedger->RECIEPIENT = "API_ZENITH";
                            }
                            elseif ($bank=="6010406900"){
                                $feeLedger->RECIEPIENT = "API_ZENITH";
                            }
                            else{
                            ...
                            if ($feeLedger->save()) {
                                ...
                                @StudentModel::where("INDEXNO", $indexno)->orWhere("STNO", $indexno)->update(array("STATUS"=>"In school"));
                                @$this->updateReceipt();
                                \DB::commit();
