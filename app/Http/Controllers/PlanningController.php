...
public function showFileUploadResults(SystemController $sys){
...

    {
       ...
       // dd($resultb);
        ...
        return Excel::create($partYear, function ($excel) use ($kojoSense, $sys, $programPopulation, $genderProgram, $genderFaculty, $genderDepartment, $interNation, $region, $genderAdmit, $genderAdmitPrevious, $yearcc, $bestProgramme, $insure ,$service, $genderAdmitProgram){
