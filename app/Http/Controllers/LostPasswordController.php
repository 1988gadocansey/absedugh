...

{
    ...
    public function sendNewPassword(Request $request,SystemController $sys)

    {
       ...
       $message="Hi, your new password is $sendPass. Keep it well as SMS is expensive.";
        ...
        if(!empty($query)){
           ...
           if( \App\User::where('fund',$email)->update(array('password'=>$password))){
               ...
               // fire sms
                ...
                $sys->firesms($message, $query->phone,$email) ;
         ...
         if($query){
              ...
              return redirect("logout")->with("success","<span style='font-weight:bold;font-size:13px;'>Password changed </span> ");
